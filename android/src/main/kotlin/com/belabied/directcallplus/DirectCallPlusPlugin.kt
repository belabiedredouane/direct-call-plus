package com.belabied.directcallplus
...
/** DirectCallPlusPlugin  */
class DirectCallPlusPlugin : FlutterPlugin, ActivityAware {
    private var handler: DirectCallPlusHandler? = null
    override fun onAttachedToEngine(binding: FlutterPluginBinding) {
        handler = DirectCallPlusHandler()
        val channel = MethodChannel(
            binding.binaryMessenger, "direct_call_plus"
        )
...
internal class DirectCallPlusHandler :
